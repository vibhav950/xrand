...
* Generation of random data with high security strength - the randomness pool maintains a high entropy reserve for key, nonce, salt, IV, and token generation.
...
* Fast SP 800-90A DRBG for generating large volumes of random data for uses like securely wiping disk sectors and SSL/TLS key generation on high-traffic servers.
